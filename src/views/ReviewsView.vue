...
<template>
  <main class="bg-white pb-20 pt-8 lg:pb-28 lg:pt-12">
    <div class="mx-auto max-w-6xl px-4 lg:px-8">
      ...
      <header class="mx-auto mt-10 max-w-3xl text-center">
        <h1 class="font-heading text-4xl text-brand md:text-5xl">{{ t('reviews.pageTitle') }}</h1>
        <p class="mt-5 text-base leading-relaxed text-brand/75 md:text-lg">
          {{ t('reviews.pageLead') }}
        </p>
      </header>

      <p class="mx-auto mt-12 max-w-3xl text-center text-base leading-relaxed text-brand/80 md:text-lg">
        {{ t('reviews.accent') }}
      </p>
