...
const es = {
  ...
  body: [
    ...
    '• Atención al cliente y asesoramiento en el punto de venta',
    '• Apoyo en la recepción, reposición y organización de mercancía',
    '• Formación en técnicas de venta y comunicación con clientes',
    '• Participación en los procesos comerciales internos de tienda',
...
const en = {
  ...
  body: [
    ...
    '• Customer service and advice at the point of sale',
    '• Support with receiving, restocking, and organizing merchandise',
    '• Training in sales techniques and customer communication',
    "• Participation in the store's internal commercial processes",
    h2('TOOLS AND SKILLS'),
    h3('What I use'),
    h3('SOCIAL'),
    'Instagram, Facebook, TikTok, LinkedIn, Meta Business Suite.',
...
const ua = {
  ...
  body: [
    ...
    '• Обслуговування клієнтів і консультації в точці продажу',
    '• Допомога з прийомом, поповненням полиць і організацією товару',
    '• Навчання технікам продажів і комунікації з клієнтами',
    '• Участь у внутрішніх комерційних процесах магазину',
